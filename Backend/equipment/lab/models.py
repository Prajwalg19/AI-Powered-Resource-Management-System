...
class Equipment(models.Model):
    ...
    invoice_number = models.ForeignKey(Invoice, on_delete=models.CASCADE)  # Use 'Invoice' as a __str__ing
...
class EquipmentReview(models.Model):
    ...
    lab_incharge = models.ForeignKey(Lab, on_delete=models.CASCADE)  # Use 'LabInCharge' as a __str__ing
