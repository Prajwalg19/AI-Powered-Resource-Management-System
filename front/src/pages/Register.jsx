            ...
            <form onSubmit={onSubmit}>
                <div className="absolute bottom-0 left-0 right-0 flex flex-col items-center justify-center top-4 ">
                    ...
                    <div className=" flex flex-col w-full max-w-md gap-8 ">
                        <input onChange={onChange} required id="name" type="text" value={name} placeholder="name" className="px-4 py-3 rounded-md" />{errors.name && <span className="text-red-600">{errors.name}</span>}
                        ...
                        <input onChange={onChange} required id="password2" type="password" value={password2} placeholder="Confirm Password" className="px-4 py-3 rounded-md" />{errors.password2 && <span className="text-red-600">{errors.password2}</span>}
