        ...
        <main className="flex flex-col flex-wrap items-center justify-center w-full h-full max-w-6xl px-5 mx-auto mt-3 md:px-2">
          <div className="w-[90%] md:w-[68%]  lg:w-[50%]">
            <div className="flex flex-col gap-2">
              <label
                htmlFor="equipment_serial_number"
            ...
            <div className="flex items-center w-full space-x-2">
              <div className="flex flex-col w-full gap-2">
                ...
                <select
                  className="w-full mb-6 border-gray-300 rounded-md"
                  required
                  id="lab_number"
                  onChange={onChange}
                >
              ...
              <div className="flex flex-col w-full gap-2">
                ...
                <input
                  ...
                  value={life}
                  min="0"
                  className="w-full mb-6 border border-gray-300 rounded-md "
                />
              </div>
              ...
              <div className="flex flex-col w-full gap-2">
                ...
                <select
                  ...
                  onChange={onChange}
                  id="invoice_number"
                  className="mb-6 border-gray-300 rounded-md"
                >
